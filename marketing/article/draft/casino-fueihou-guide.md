...
契約前に管轄の警察署へ事前相談するのが鉄則です。契約後に「ここはダメ」と言われるリスクを避けられます。
...
書類審査のあと、警察が営業所を実地確認します。図面通りの設備配置かがチェックされます。
...
保護対象施設との距離が足りず、契約後に許可が取れないケースがあります。契約前の事前相談は必須です。

### 「深夜営業」ができない

4号営業の営業時間は午前0時までです。深夜帯こそ来客が増える業態なので、業界最大のボトルネックの一つといえます。

「飲食店営業」として深夜帯を運営しゲームは提供しない形を取る店舗もありますが、実態が遊技場営業と判断されれば違法になります。
...
営業所ごとに「管理者」を選任し届け出る義務があります。管理者の変更時も届出が必要です。
...
不明点は管轄の警察署・生活安全課への事前相談が最も確実です。

---

> 開業後のトーナメント運営を効率化するアミューズメントカジノ専用ツール「Casinohub」を開発中です。参加者管理・ブラインドタイマー・順位集計を自動化します。[ウェイティングリストはこちら]。
